...
const ProductBasic = sequelize.define(
    'product_basic',{
    ...
    'category_eng': {type: DataTypes.STRING},
    'image_addr':{type: DataTypes.STRING},
    'create_day': {type: DataTypes.DATE, defaultValue: Date.now()}
},{
